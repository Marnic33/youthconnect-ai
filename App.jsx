...
// ─── APPROVALS ────────────────────────────────────────────────────────────────
function ApprovalsModule({ pending, setPending, youth, setYouth }) {
  function approve(p) {
    const approved = { ...p, approved:true, id:"y"+Date.now() };
    ...
    <div style={{ minHeight:"100vh", background:"#0f172a", fontFamily:"'DM Sans', system-ui, sans-serif", color:"#f1f5f9" }}>
      ...
      <div style={{ marginLeft:220, paddingTop:56 }}>
        <div style={{ padding:24, maxWidth:1200 }}>
          ...
          {page === "approvals" && <ApprovalsModule pending={pending} setPending={setPending} youth={youth} setYouth={setYouthAndUpdate} />}
